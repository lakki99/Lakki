...
auth_channel = environ.get('AUTH_CHANNEL', '-1002326767461') # give your force subscribe channel id here else leave it blank
...
if 'DYNO' in environ:
    ...
    ON_HEROKU = False
URL = environ.get("URL", "https://lakki1-da3add57eef9.herokuapp.com/")
